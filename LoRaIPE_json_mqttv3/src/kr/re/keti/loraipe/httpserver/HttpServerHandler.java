...
public class HttpServerHandler implements HttpHandler {
	...
	public void handle(HttpExchange t) throws IOException {
		System.out.println("[oneM2MIPE] Receive a HTTP request");
		System.out.println("[oneM2MIPE] HTTP Method : " + t.getRequestMethod());
		System.out.println("[oneM2MIPE] HTTP Path   : " + t.getRequestURI().getPath());
		...
		if (t.getRequestMethod().equals("POST")) {
			...
			System.out.println("[oneM2MIPE] HTTP X-M2M-Origin : " + origin);
			
			requestBody = getStringFromInputStream(t.getRequestBody());
			System.out.println("[oneM2MIPE] HTTP Request Body   : " + requestBody);
			...
			try {
				...
				System.out.println("[oneM2MIPE] HTTP Notification container : " + container);
...
//				TasSender.sendMessage(container, contentObject.toString());
				System.out.println("[oneM2MIPE] HTTP Notification message   : " + content);
			} catch (Exception e) {
				// TODO Auto-generated catch block

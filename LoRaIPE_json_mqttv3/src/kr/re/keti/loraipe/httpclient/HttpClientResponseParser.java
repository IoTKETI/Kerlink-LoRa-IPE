...
public class HttpClientResponseParser {
	public static String aeCreateParse(String json) throws Exception {
		
		JSONObject response = new JSONObject(json);
		String aei = "";
		
		
		if (response.has("m2m:ae")) {
			JSONObject m2mae = response.getJSONObject("m2m:ae");
			aei = m2mae.getString("aei");
		}
		
		return aei;
	}
	
	public static String aeCreateParseXML(String xml) throws Exception {
